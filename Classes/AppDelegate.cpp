...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        // 窗口大小
        glview = GLViewImpl::createWithRect("CardGame", cocos2d::Rect(0, 0, APP_WINDOW_SIZE_WIDTH, APP_WINDOW_SIZE_HEIGHT));
#else
    ...
    */
    ...
    // 使用GameController创建场景
    auto scene = _gameController->startGame(LEVEL_ID);
    scene->addChild(_gameController);
